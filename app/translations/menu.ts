...
export const menuTranslations: Record<'ru' | 'kz' | 'en', MenuTranslations> = {
  ...
  kz: {
    categories: {
      ...
      coffee: 'Кофе',
      signatureCoffee: 'Авторлық кофе',
      alternativeCoffee: 'Балама кофе',
      authorTea: 'Авторлық шай',
      leafTea: 'Жапырақты шай (L)',
      hotDrink: 'Ыстық сусын',
      icedTea: 'Мұзды шай (L)',
      coldDrink: 'Салқын сусын (L)',
      lemonade: 'Лимонад (L)',
      cocktail: 'Коктейль (L)',
      espressoTonic: 'Эспрессо тоник (L)',
      fresh: 'Фреш (L)',
    ...
    items: {
      ...
      karakTea: 'Қарақ шай',
      seaBuckthorn: 'Шырғанақ-Маракуйя',
      gingerLemonHoney: 'Зімбір-Лимон-Бал',
      raspberryMint: 'Таңқурай-Жалбыз',
      assam: 'Ассам',
      earlGrey: 'Эрл Грей',
      sencha: 'Сенча',
