      ...
      <div className="absolute bottom-4 left-0 right-0">
        <div className="max-w-[80rem] mx-auto px-4">
          <div className="text-white text-xs opacity-50 text-right">
            <div className="text-shadow text-right">© RAUL. All rights reserved.</div>
            <div className="text-shadow text-right">Astana, Turkestan 16, 22nd floor.</div>
            <div className="text-shadow text-right">Photography — Tolegen Nurbekovich.</div>
          </div>
        </div>
      </div>
    </div>
