      ...
      <nav className={navClassName} suppressHydrationWarning>
        <div className="nav-content px-6 md:px-6">
          ...
          <div className="flex items-center gap-8">
            ...
            <div className="hidden md:flex items-center gap-8">
              <Link
                href="/eu/menu"
                className={`nav-link ${pathname === '/eu/menu' ? 'font-bold' : ''}`}
                suppressHydrationWarning
              >
                Menu
              </Link>
              <Link
                href="/eu/about"
                className={`nav-link ${pathname === '/eu/about' ? 'font-bold' : ''}`}
                suppressHydrationWarning
              >
                About
              </Link>
              <Link
                href="/eu/contacts"
                className={`nav-link ${pathname === '/eu/contacts' ? 'font-bold' : ''}`}
                suppressHydrationWarning
              >
                Contacts
              </Link>
        ...
        <div className={`mobile-menu ${isMenuOpen ? 'open' : ''}`}>
          <div className="mobile-menu-content">
            ...
            <button 
              className={`mobile-nav-link ${pathname === '/eu/menu' ? 'font-bold' : ''}`}
            ...
            <button 
              className={`mobile-nav-link ${pathname === '/eu/about' ? 'font-bold' : ''}`}
            ...
            <button 
              className={`mobile-nav-link ${pathname === '/eu/contacts' ? 'font-bold' : ''}`}
